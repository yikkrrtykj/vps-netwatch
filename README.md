> `vps-netwatch` 现在改为基于 [Nezha Monitoring](https://github.com/nezhahq/nezha) 的自定义源码仓库。
>
> 先用官方哪吒跑稳定的多 VPS 监控，再在这个仓库里改源码、构建自己的 Dashboard 镜像。具体使用步骤见 [VPS-NETWATCH.md](VPS-NETWATCH.md)。
