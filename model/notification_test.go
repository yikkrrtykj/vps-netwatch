...
func TestNotification(t *testing.T) {
	cases := []testSt{
		...
		{
			url:               "https://example.com/?m=#VPS_NETWATCH#",
			body:              `{"asd":"dsa"}`,
			reqMethod:         NotificationRequestMethodGET,
		...
		{
			url:               "https://example.com/?m=#VPS_NETWATCH#",
			body:              `{"#VPS_NETWATCH#":"#VPS_NETWATCH#"}`,
			reqMethod:         NotificationRequestMethodPOST,
			reqType:           NotificationRequestTypeForm,
			expectURL:         "https://example.com/?m=" + msg,
			expectMethod:      http.MethodPost,
			expectContentType: reqTypeForm,
			expectBody:        "%23VPS_NETWATCH%23=" + msg,
		},
		{
			url:               "https://example.com/?m=#VPS_NETWATCH#",
			body:              `{"asd":"#VPS_NETWATCH#"}`,
		...
		{
			url:               "https://example.com/?m=#VPS_NETWATCH#",
			body:              `{"#VPS_NETWATCH#":"#VPS_NETWATCH#","Server":"#SERVER.NAME#","ServerIP":"#SERVER.IP#","ServerSWAP":"#SERVER.SWAP#"}`,
			reqMethod:         NotificationRequestMethodPOST,
			reqType:           NotificationRequestTypeForm,
			expectURL:         "https://example.com/?m=" + msg,
			expectMethod:      http.MethodPost,
			expectContentType: reqTypeForm,
			expectBody:        "%23VPS_NETWATCH%23=" + msg + "&Server=ServerName&ServerIP=1.1.1.1&ServerSWAP=100.00+%25",
		},
		{
			url:               "https://example.com/?m=#VPS_NETWATCH#",
		...
		{
			url:               "https://example.com/?m=#VPS_NETWATCH#",
			body:              `{"#VPS_NETWATCH#":"#VPS_NETWATCH#","Server":"#SERVER.NAME#","ServerIP":"#SERVER.IP#","ServerSWAP":"#SERVER.SWAPUSED#"}`,
			reqMethod:         NotificationRequestMethodPOST,
			reqType:           NotificationRequestTypeForm,
			expectURL:         "https://example.com/?m=" + msg,
			expectMethod:      http.MethodPost,
			expectContentType: reqTypeForm,
			expectBody:        "%23VPS_NETWATCH%23=" + msg + "&Server=ServerName&ServerIP=1.1.1.1&ServerSWAP=8888",
		},
	}
