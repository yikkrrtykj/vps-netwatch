...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent =
      ...
      "@media(max-width:760px){.vpsnw-chart{height:300px;padding-left:8px;padding-right:8px}.vpsnw-head{grid-template-columns:1fr}.vpsnw-top-row{align-items:flex-start;flex-direction:column;gap:8px}.vpsnw-range{margin-left:0;min-width:0;max-width:100%;text-align:left;white-space:normal}}";
  ...
  function createPanel(host) {
    ...
    if (!panel) {
      ...
      panel.hidden = true;
      panel.innerHTML =
        '<div class="vpsnw-head"><div><div class="vpsnw-title">延迟</div></div><div class="vpsnw-head-side"><div class="vpsnw-top-row"><div class="vpsnw-server-tabs" id="vpsnw-server-tabs"></div><div class="vpsnw-sub vpsnw-range" id="vpsnw-range">加载中</div></div><div class="vpsnw-peer-row"><span class="vpsnw-peer-label">互 ping 目标</span><div class="vpsnw-peer-tabs" id="vpsnw-peer-tabs"></div><span class="vpsnw-peer-note" id="vpsnw-peer-note"></span></div></div></div>' +
